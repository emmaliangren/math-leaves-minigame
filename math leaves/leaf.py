...
class Leaf(pygame.sprite.Sprite):
    ...
    def __init__(self, x=0, y=0, num1=0, num2=0, ans=0, speed=1):
        ...
        self.images = [pygame.image.load("images/leaf1.png"),pygame.image.load("images/leaf2.png"),pygame.image.load("images/leaf3.png")]
        self.image = self.images[random.randint(0,2)]
        self.rect = self.image.get_rect()
        self.rect.x, self.rect.y = x, y
        self.speed = speed
        self.sound = pygame.mixer.Sound("audio/leaf crunch.mp3")
        self.ans = ans
